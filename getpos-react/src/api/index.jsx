...
const APIs = {
  ...
  getDefaultCustomer: '/api/method/getpos.getpos.api.get_default_customer',
  getSalesOrderList: '/api/method/getpos.getpos.api.get_sales_order_list',
  getKitchenOrderList: '/api/method/getpos.getpos.api.get_kitchen_order_list',
  SalesOrderURL: '/api/resource/Sales Order',
